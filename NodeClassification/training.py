...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', type=str, choices=['GCN', 'GAT', 'APPNP', 'ChebNet', 'GPRGNN','BernNet','MLP','GraInc','AFGCN','SIGN','GraIncV2','GraIncV3','FAGCN','SGC','GraphSAGE','ConvG'], default='SIGN')
